      ...
      <>
       ...
       <div>
        ...
        <section className="m-news is_row">
          <article className="m-news__item">
            <div className="m-news__img"><img itemProp="image" src="https://picsum.photos/500/400?random=8" alt="news" /></div>
            <div className="m-news__content">
              <div className="m-news__heading"> 
                <div className="m-news__cate"> <a href="#">Quan điểm - Tranh luận</a><span>5 phút đọc </span></div>
                <div className="m-news__save"> <i className="gg-bookmark" /></div>
          ...
          <article className="m-news__item">
            <div className="m-news__img"><img itemProp="image" src="https://picsum.photos/500/400?random=9" alt="news" /></div>
            <div className="m-news__content">
              <div className="m-news__heading"> 
                <div className="m-news__cate"> <a href="#">Quan điểm - Tranh luận</a><span>5 phút đọc </span></div>
                <div className="m-news__save"> <i className="gg-bookmark" /></div>
          ...
          <article className="m-news__item">
            <div className="m-news__img"><img itemProp="image" src="https://picsum.photos/500/400?random=10" alt="news" /></div>
            <div className="m-news__content">
              <div className="m-news__heading"> 
                <div className="m-news__cate"> <a href="#">Quan điểm - Tranh luận</a><span>5 phút đọc </span></div>
                <div className="m-news__save"> <i className="gg-bookmark" /></div>
        ...
        <section className="row">
          <div className="col-9">
            ...
            <div className="m-news is_vertical">
              ...
              <article className="m-news__item">
                <div className="m-news__img"><img itemProp="image" src="https://picsum.photos/500/400?random=2" alt="news" /></div>
                <div className="m-news__content">
                  <div className="m-news__heading"> 
                    <div className="m-news__cate"> <a href="#">Quan điểm - Tranh luận</a><span>5 phút đọc </span></div>
                    <div className="m-news__save"> <i className="gg-bookmark" /></div>
              ...
              <article className="m-news__item">
                <div className="m-news__img"><img itemProp="image" src="https://picsum.photos/500/400?random=3" alt="news" /></div>
                <div className="m-news__content">
                  <div className="m-news__heading"> 
                    <div className="m-news__cate"> <a href="#">Quan điểm - Tranh luận</a><span>5 phút đọc </span></div>
                    <div className="m-news__save"> <i className="gg-bookmark" /></div>
              ...
              <article className="m-news__item"><a className="m-news__img" href="/singer.html"><img itemProp="image" src="https://picsum.photos/500/400?random=4" alt="news" /></a>
                <div className="m-news__content">
                  <div className="m-news__heading"> 
                    <div className="m-news__cate"> <a href="#">Quan điểm - Tranh luậnx</a><span>5 phút đọc </span></div>
                    <div className="m-news__save"> <i className="gg-bookmark" /></div>
                  </div><a href="/singer.html">
                    <h2 className="m-title" itemProp="name">Fuckbois, PUA, Single Mom, Red Pills và tác dụng phụ của thuốc.</h2></a>
                  <div className="m-news__ext"> Văn hoá phương Tây du nhập vào kéo theo hàng loạt những...Văn hoá phương Tây du nhập vào kéo theo hàng loạt những... </div>
